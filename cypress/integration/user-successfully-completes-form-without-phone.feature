Feature: Form
  ...
  @form
  @user-successfully-completes-form-without-phone

  Scenario: User successfully completes form without phone
    ...
    And I see I have entered "-" for the "Phone Number" field
